/******************************************************************************
 ** File Name:      sc8800g_auddev_cfg.h                                      *
 ** Author:         Jeff Li                                                   *
 ** DATE:           16/09/2010                                                *
 ...
 ******************************************************************************/
#ifndef _SC8800G_AUDDEV_CFG_H
#define _SC8800G_AUDDEV_CFG_H
...
#define DOL_REG_GET(_Reg)                       CHIP_REG_GET(_Reg)
#define DOLPHIN_REG_BASE    ARM_VBC_ANA_BASE
#define VB_CLK_CTL          GR_BUSCLK_ALM
...
#define VBCR2_MICSEL_MIC1           (1 << VBCR2_MICSEL_SHIFT)
#define VBCR2_MICSEL_MIC2           (0 << VBCR2_MICSEL_SHIFT)
#endif

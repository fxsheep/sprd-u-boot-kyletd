...
static unsigned long sdio_func_cfg[] = {
	...
	MFP_CFG_X(SD0_CMD, AF0, DS1, F_PULL_UP,  S_PULL_NONE, IO_Z),
	MFP_CFG_X(SD0_D0, AF0, DS1, F_PULL_UP, S_PULL_NONE, IO_Z),
	MFP_CFG_X(SD0_D1, AF0, DS1, F_PULL_UP, S_PULL_NONE, IO_Z),
	MFP_CFG_X(SD0_D2, AF0, DS1, F_PULL_UP, S_PULL_NONE, IO_Z),
	MFP_CFG_X(SD0_D3, AF0, DS1, F_PULL_UP, S_PULL_NONE, IO_Z),
	MFP_CFG_X(SD1_CLK, AF0, DS3, F_PULL_NONE, S_PULL_NONE, IO_Z),
	MFP_CFG_X(SD1_CMD, AF0, DS1, F_PULL_UP,  S_PULL_NONE, IO_Z),
	MFP_CFG_X(SD1_D0, AF0, DS1, F_PULL_UP, S_PULL_NONE, IO_Z),
	MFP_CFG_X(SD1_D1, AF0, DS1, F_PULL_UP, S_PULL_NONE, IO_Z),
	MFP_CFG_X(SD1_D2, AF0, DS1, F_PULL_UP, S_PULL_NONE, IO_Z),
	MFP_CFG_X(SD1_D3, AF0, DS1, F_PULL_UP, S_PULL_NONE, IO_Z),
};

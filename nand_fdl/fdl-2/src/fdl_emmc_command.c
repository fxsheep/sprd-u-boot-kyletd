...
int FDL2_eMMC_DataEnd (PACKET_T *packet, void *arg)
{
	...
	if (is_nv_flag) {
		...
		if (backupnvitem_count) {
			...
			if (!Emmc_Read(PARTITION_USER, base_sector, nSectorCount,
